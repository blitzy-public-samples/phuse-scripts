...
#                       Demographics panel encounters missing variables or    #
...
#                                                                             #
#   MIGRATION DETAILS:                                                        #
#     - Migrated from: contributed/Demographics/Utility Programs/err_output.sas
...
#' Demographics panel encounters missing variables or no subjects.
